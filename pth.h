...
#define PERTASK                     0x4
    ...
    /* queries for tcb flag */
#define PTH_TASK_RT             _BIT(0)
#define PTH_TASK_HARD           _BIT(1)
#define PTH_TASK_PERIOD         _BIT(2)
#define PTH_TASK_DONE           _BIT(3)
#define PTH_TASK_INH_PRIO       _BIT(4)

    /* interval of pth tick scheduler */
#define PTH_INTERVAL                10000
...
enum {
    ...
    PTH_ATTR_EXETIME,        /* RW [pth_time_t]        time thread demand execute        */
    PTH_ATTR_PERIOD,         /* RW [pth_time_t]        time thread execute period        */
    PTH_ATTR_TYPE,           /* RW [int]               task type                         */
...
extern int            pth_mod_main_attr(pth_attr_t);
